...
typedef int  (*FieldMethod) (class FieldObj &,  VectorObj &, class BufferArray &, VectorObj &, double dt, double);
typedef int  (*BufferMethod)(class BufferObj &, VectorObj &, class FieldObj &,    VectorObj &, double dt, double); 
...
public:
  ...
  int Step(FieldMethod Method, VectorObj &Next, class BufferArray& Bufs, class VectorObj &Lin, double dt, double T)
    { return (*Method)(*this, Next, Bufs, Lin, dt, T); }
...
class BufferObj : public FieldObj
{
 ...
 public:
  ...
  int Step(BufferMethod Method, VectorObj &Next, FieldObj &Ca, VectorObj &Lin, double dt, double T)
    { return (*Method)(*this, Next, Ca, Lin, dt, T); }
};
...
public:
  ...
  void Step(BufferMethod Method, VectorObj &Next, FieldObj& Ca, VectorObj &Lin, double dt, double T) { 
    for (int i = 0; i < buf_num; i++) array[i]->Step(Method, Next, Ca, Lin, dt, T); }
